...
extern void cpg_update_Psqrt(c_int idx, c_float val);
extern void cpg_update_Qsqrt(c_int idx, c_float val);
extern void cpg_update_Rsqrt(c_int idx, c_float val);
